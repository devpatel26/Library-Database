  ...
  return (
    <section className="mx-auto flex w-full max-w-4xl flex-col items-center rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-12 text-center">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
        Join our library community to borrow items, manage holds, and access digital resources.
      </p>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <input required id="email" name="email" type="email" placeholder="jane@example.com" className={inputClasses} />
            </div>
            <div>
              <label htmlFor="password" className={labelClasses}>Password</label>
              <input required id="password" name="password" type="password" placeholder="Min. 8 characters" className={inputClasses} />
            </div>
          </div>

          <div className="flex flex-col items-center pt-6">
            <SubmitButton title={"Register Account"} value={"OK"} halfwidth={true} />
