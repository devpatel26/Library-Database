...
function NavSection({ title, links }) {
  ...
  return (
    <div className="mb-6">
      <p className="mb-2 px-6 text-xs font-bold uppercase tracking-[0.2em] text-white">
        {title}
      </p>
      ...
      <div className="space-y-1">
        {links.map(({ to, label }) => (
          <NavLink
            ...
            to={to}
            className={({ isActive }) =>
              `block w-full px-6 py-2.5 text-sm transition-colors ${
                isActive
      ...
      <BrowserRouter>
        <div className="min-h-screen flex flex-col font-sans">
          ...
          <div className="flex flex-1 overflow-hidden">
            {/* Collapsible Sidebar */}
            <aside
              className={`bg-[#164e63] transition-all duration-300 ease-in-out flex-shrink-0 z-0 py-6 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center md:text-left">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li><a href="#" className="hover:text-white transition-colors">Item Requests</a></li>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li><NavLink to="/policies" className="hover:text-white transition-colors">Library Policies</NavLink></li>
                    <li><NavLink to="/" className="hover:text-white transition-colors">Library Collection</NavLink></li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-white font-bold mb-3 text-lg">About Us</h3>
                  <ul className="space-y-2">
                    <li><NavLink to="/about" className="hover:text-white transition-colors">About Datahaven Library</NavLink></li>
                    <li><NavLink to="/hours" className="hover:text-white transition-colors">Library Hours</NavLink></li>
                  </ul>
                </div>
              </div>
